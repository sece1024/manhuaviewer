const api = {
  ...
  getArchiveTags: jest.fn().mockResolvedValue([]),
  ...
  batchAssignTag: jest.fn().mockResolvedValue({ success: true, affected: 0 }),
  batchRemoveTag: jest.fn().mockResolvedValue({ success: true, affected: 0 }),
  getCategories: jest.fn().mockResolvedValue([]),
  getArchiveCategories: jest.fn().mockResolvedValue([]),
  ...
  batchAssignCategory: jest.fn().mockResolvedValue({ success: true, affected: 0 }),
  batchRemoveCategory: jest.fn().mockResolvedValue({ success: true, affected: 0 }),
